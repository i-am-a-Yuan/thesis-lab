# -*- coding: utf-8 -*-
"""
Created on Thu Apr  9 05:46:00 2026
...
# 导出
# slx_table.to_excel("SEM_X2_multiW.xlsx")
slx_table.to_excel("SLX1_results_multiW_delta.xlsx")
# slx_table.to_excel("SEM1_Weights_3f_full.xlsx") # -ln_pop
# slx_table.to_excel("SEM2_Weights_3f.xlsx") # -ln_pop -ln_poi -ln_gdp
