# -*- coding: utf-8 -*-
"""
Created on Sat Mar 14 16:58:15 2026
...
for name, w in weights.items():
    ...
    ## choose variable for lag in 2km data in 
    # TTFTFT
    # sdm = ML_Lag(
    #     y,
    #     X.values,
    ...
    #     # *         *           -           *         -         *
    #     # TTFTFT
    #     slx_vars=[True, True, False, True, False, True],
    #     name_y = "ln_access",
    #     name_x = list(X.columns)
    #     )
    ...
    #     # -         *           -           *         -         *
    #     # -TFTFT
    #     slx_vars=[True, False, True, False, True],
    #     name_y = "ln_access",
    #     name_x = list(X.columns)
    ...
    # *         *           *           *         -         *
    # TTTT-T
    # slx_vars=[True, True, True, True, True],
    # *         *           *                     -         *
    # TTFT-T
    # slx_vars=[True, True, False, True, True],
    # *         *           *           *         -         
    # TTTT-F
    # slx_vars=[True, True, True, True, False],
    # *         *           *                     -         *   
    # TTTF-T
    # slx_vars=[True, True, True, False, True],
...
# 输出
# ---------------------------
table.to_excel("SDM_results_multiW.xlsx")
# table.to_excel("SDM1_result_multiW_2k_TTFTFT.xlsx")
# table.to_excel("SDM1_result_multiW_2k_-TFTFT.xlsx")
# table.to_excel("SDM1_result_multiW_2k_TTTT-T.xlsx")
# table.to_excel("SDM1_result_multiW_2k_TTFT-T.xlsx")
# table.to_excel("SDM1_result_multiW_2k_TTTT-F.xlsx")
# table.to_excel("SDM1_result_multiW_2k_TTTF-T.xlsx")



# table.to_excel("SDM1_result_full.xlsx")
# table.to_excel("SDM2_result.xlsx")
